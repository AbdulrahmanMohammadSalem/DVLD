...
namespace DVLD.Application_Settings {
    public partial class Frm_ApplicationSettings : SalForm, IEnforcePermissions {
        ...
        private void SystemEvents_UserPreferenceChanged(object sender, UserPreferenceChangedEventArgs e) {
            if (e.Category.In(UserPreferenceCategory.Color, UserPreferenceCategory.General) && cb_colorMode.SelectedIndex == (int) ColorModes.System && _selectedColorMode != DrawingHelpers.GetSystemTheme())
                cb_colorMode_SelectedIndexChanged(cb_colorMode, EventArgs.Empty);
        }
        ...
        private void ll_deleteSelectedTheme_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e) {
            ...
            if (_selectedTheme.Delete()) {
                ...
                if (_selectedTheme.ThemeID == Settings.Default.CurrentThemeID) {
