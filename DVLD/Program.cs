...
namespace DVLD {
    internal static class Program {
        ...
        private static void InitializeOtherFields() {
            ...
            EventLogger.Configure("DVLD", "Application");
        }
        ...
        private static void SystemEvents_UserPreferenceChanged(object sender, UserPreferenceChangedEventArgs e) {
            if (e.Category.In(UserPreferenceCategory.Color, UserPreferenceCategory.General) && Settings.Default.CurrentThemeColorMode == ColorModes.System && DrawingHelpers.GetSystemTheme() != Settings.Default.TitleBarColorMode) {
                DVLD_Business.Theme _savedTheme = DVLD_Business.Theme.Find(Settings.Default.CurrentThemeID);
