...
namespace DVLD.Licenses.Layouts {
    public partial class Layout_ShowAllLicenses : ClosableLayout, IDataConsumer, IEnforcePermissions {
        private Font _smallSegoeFluentIcons, _bigSegoeFluentIcons;
        public Layout_ShowAllLicenses() {
            _smallSegoeFluentIcons = new Font("Segoe Fluent Icons", 8F);
            _bigSegoeFluentIcons = new Font("Segoe Fluent Icons", 10F);
        ...
        private void _SetupLocalTableHeader() {
            ...
            dgv_localLicenses.Columns[9].Visible = false; //This is the boolean IsDetained column from the database. I'll not show it but use the image column instead.
        }
        ...
        private void dgv_localLicenses_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e) {
            if (e.Value is null)
                return;
            ...
            if (_sender.Columns[e.ColumnIndex].ValueType == typeof(DateTime)) {
                ...
                if (_sender.Columns[e.ColumnIndex].ValueType == typeof(DateTime) && DateTime.Now > _val)
                ...
                if ((byte) e.Value == 1) {
                    e.CellStyle.Font = _bigSegoeFluentIcons;
                    e.CellStyle.ForeColor = Color.Green;
                    e.Value = "\uf78c";
                } else {
                    e.CellStyle.Font = _smallSegoeFluentIcons;
                    e.CellStyle.ForeColor = Color.Red;
                    e.Value = "\uf78a";
                }
