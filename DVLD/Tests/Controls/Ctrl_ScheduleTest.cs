    ...
    public partial class Ctrl_ScheduleTest : UserControl {
        ...
        public bool SaveAppointment() {
            ...
            if (_ActiveMode == Modes.AddNew) {
                ...
                _TestAppointment = new TestAppointment() {
                    ...
                    FeesPaid = decimal.Parse(lbl_testFees.Text, System.Globalization.NumberStyles.Currency),
                    IsLocked = false,
            ...
            if (_retakeFailedTestAppID != null) //Retake test
                DVLD_Business.Application.Delete(_retakeFailedTestAppID.Value); //If this failed... I don't know... (we may keep track of all failed deletions and occasionally try to delete them in the background without the user knowing but this would be complicated and I don't want to do it, and an SQL Transaction would be better anyways)
        ...
        private bool _CreateNewRetakeTestApplication(DateTime applicationDate, ref int? retakeFailedTestAppID) {
            DVLD_Business.Application _retakeFailedTestApp = new DVLD_Business.Application() {
                ...
                FeesPaid = decimal.Parse(lbl_retakeTestAppFees.Text, System.Globalization.NumberStyles.Currency)
            };
