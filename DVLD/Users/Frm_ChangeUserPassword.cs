...
namespace DVLD.Users {
    public partial class Frm_ChangeUserPassword : SalForm {
        ...
        private void txt_currentNewPassword_Validating(object sender, CancelEventArgs e) {
        ...
        private void textBox_confirmPassword_Validating(object sender, CancelEventArgs e) {
            if (txt_newPassword.Text != string.Empty && txt_confirmPassword.Text != string.Empty && txt_confirmPassword.Text != txt_newPassword.Text) {
                errorProvider1.SetError(txt_confirmPassword, Str_FrmChangeUserPassword.invalidConfirmPasswordInput);
                e.Cancel = true;
        ...
        private void button_save_Click(object sender, EventArgs e) {
            ...
            if (Crypto.Hash(txt_currentPassword.Text) != _User.HashedPassword) {
            ...
            if (_User.UpdatePassword(Crypto.Hash(txt_newPassword.Text))) {
                ...
                txt_currentPassword.Text = txt_newPassword.Text = txt_confirmPassword.Text = string.Empty;
            }
            else
        ...
        private bool _ValidateFieldsAsRequired() {
            ...
            if (txt_confirmPassword.Text == string.Empty) {
                errorProvider1.SetError(txt_confirmPassword, Resources.txt_requiredField);
                _result = false;
            }

            if (txt_newPassword.Text == string.Empty) {
                errorProvider1.SetError(txt_newPassword, Resources.txt_requiredField);
                _result = false;
            }

            if (txt_currentPassword.Text == string.Empty) {
                errorProvider1.SetError(txt_currentPassword, Resources.txt_requiredField);
                _result = false;
            }
