    ...
    public partial class Frm_AddEditUser : SalForm, IEnforcePermissions {
        ...
        private void Frm_AddEditUser_Load(object sender, EventArgs e) {
            if (_ActiveMode == Modes.AddNew)
                ...
                txt_password.PasswordChar = txt_confirmPassword.PasswordChar = '\0';
                txt_password.Text = txt_confirmPassword.Text = Str_FrmAddEditUser.notAvailable;
                chk_isActive.Checked = _User.IsActive;
                txt_password.Enabled = txt_confirmPassword.Enabled = false;
        ...
        private void ctrl_PersonCardWithFilter1_PersonSaved(int personID) {
            if (_User != null)
        ...
        private void _ResetLoginInfoPanel() {
            ...
            txt_username.Text = txt_password.Text = txt_confirmPassword.Text = string.Empty;
        ...
        private void textBox_confirmPassword_Validating(object sender, CancelEventArgs e) {
            if (txt_password.Text != string.Empty && txt_confirmPassword.Text != string.Empty && txt_confirmPassword.Text != txt_password.Text) {
                errorProvider1.SetError(txt_confirmPassword, Str_FrmAddEditUser.invalidConfirmPasswordInput);
                e.Cancel = true;
        ...
        private void txt_password_Validating(object sender, CancelEventArgs e) {
            if (txt_password.Text == string.Empty)
                errorProvider1.SetError(txt_password, Resources.txt_requiredField);
        }
        ...
        private void button_save_Click(object sender, EventArgs e) {
            ...
            if (_User is null) { //AddNew mode
                _User = new User {
                    // You cannot change these two properties while in Update Mode
                    HashedPassword = Crypto.Hash(txt_password.Text),
                    PersonID = ctrl_PersonCardWithFilter1.PersonID
                };
        ...
        private bool _ValidateLoginFields() {
            ...
            if (txt_password.Text != string.Empty && txt_confirmPassword.Text != txt_password.Text) {
                _result = false;
                errorProvider1.SetError(txt_confirmPassword, Str_FrmAddEditUser.invalidConfirmPasswordInput);
            }
