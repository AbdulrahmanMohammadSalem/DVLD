    ...
    public class ThemeColorPalette {
        ...
        public static ThemeColorPalette CreateNewPalette(ColorModes colorMode) {
            ...
            if (colorMode == ColorModes.Light) {
                _newPalette.BaseBackColor = Color.White;
                _newPalette.SurfaceBackColor = Color.White;
                _newPalette.BaseForeColor = Color.White;
                _newPalette.AccentForeColor = Color.White;
                _newPalette.BaseLinkColor = Color.White;
                _newPalette.InactiveForeColor = Color.White;
                _newPalette.StrongForeColor = Color.White;
                _newPalette.MainMenuStripColor = Color.White;
                _newPalette.GridHeaderCellColor = Color.White;
                _newPalette.GridHeaderCellHighlightColor = Color.White;
                _newPalette.SurfaceBorderColor = Color.White;
                _newPalette.SurfaceHoverColor = Color.White;
                _newPalette.InactiveTabBackColor = Color.White;
                _newPalette.MenuStripItemBorderColor = Color.White;
                _newPalette.MenuStripItemHoverBackColor = Color.White;

                _newPalette.DateTimePickerStyle = 9;
                _newPalette.SyncTextBoxStyle = 5;
            } else {
                _newPalette.BaseBackColor = Color.Black;
                _newPalette.SurfaceBackColor = Color.Black;
                _newPalette.BaseForeColor = Color.Black;
                _newPalette.AccentForeColor = Color.Black;
                _newPalette.BaseLinkColor = Color.Black;
                _newPalette.InactiveForeColor = Color.Black;
                _newPalette.StrongForeColor = Color.Black;
                _newPalette.MainMenuStripColor = Color.Black;
                _newPalette.GridHeaderCellColor = Color.Black;
                _newPalette.GridHeaderCellHighlightColor = Color.Black;
                _newPalette.SurfaceBorderColor = Color.Black;
                _newPalette.SurfaceHoverColor = Color.Black;
                _newPalette.InactiveTabBackColor = Color.Black;
                _newPalette.MenuStripItemBorderColor = Color.Black;
                _newPalette.MenuStripItemHoverBackColor = Color.Black;
