...
CREATE  TABLE dbo.Themes ( 
	...
	CONSTRAINT fk_Themes_ThemeColorPalettes FOREIGN KEY ( LightColorPaletteID ) REFERENCES dbo.ThemeColorPalettes( ColorPaletteID )  ,
	CONSTRAINT fk_Themes_ThemeColorPalettes_0 FOREIGN KEY ( DarkColorPaletteID ) REFERENCES dbo.ThemeColorPalettes( ColorPaletteID )  
 );
GO
...
CREATE  TABLE dbo.Users ( 
	...
	HashedPassword       char(64) COLLATE Arabic_CI_AS     NOT NULL,
	...
	CONSTRAINT FK_Users_Permissions FOREIGN KEY ( PermissionsID ) REFERENCES dbo.Permissions( PermissionsID ) ON DELETE CASCADE ,
	CONSTRAINT fk_Users_Persons FOREIGN KEY ( PersonID ) REFERENCES dbo.People( PersonID )  
 );
GO
...
CREATE  TABLE dbo.DetainedLicenses ( 
	...
	CONSTRAINT fk_DetainedLicenses_Licenses FOREIGN KEY ( BaseLicenseID ) REFERENCES dbo.Licenses( LicenseID )  ,
	CONSTRAINT fk_DetainedLicenses_Users FOREIGN KEY ( CreatedByUserID ) REFERENCES dbo.Users( UserID )  ,
	CONSTRAINT fk_DetainedLicenses_Users_0 FOREIGN KEY ( ReleasedByUserID ) REFERENCES dbo.Users( UserID )  
 );
GO
...
CREATE  TABLE dbo.LocalDrivingLicenseApplications ( 
	...
	CONSTRAINT fk_LocalDrivingLicenseApplications_Applications FOREIGN KEY ( ApplicationID ) REFERENCES dbo.Applications( ApplicationID ) ON DELETE CASCADE ,
	CONSTRAINT fk_LocalDrivingLicenseApplications_LicenseClasses FOREIGN KEY ( LicenseClassID ) REFERENCES dbo.LicenseClasses( LicenseClassID )  
 );
GO
...
CREATE  TABLE dbo.LocalLicenses ( 
	...
	CONSTRAINT fk_LicenseCards_LicenseClasses FOREIGN KEY ( LicenseClassID ) REFERENCES dbo.LicenseClasses( LicenseClassID )  ,
	CONSTRAINT fk_LocalLicenses_Licenses FOREIGN KEY ( BaseLicenseID ) REFERENCES dbo.Licenses( LicenseID ) ON DELETE CASCADE 
 );
GO
...
CREATE  TABLE dbo.InternationalLicenses ( 
	...
	CONSTRAINT fk_InternationalLicenses_Licenses FOREIGN KEY ( BaseLicenseID ) REFERENCES dbo.Licenses( LicenseID ) ON DELETE CASCADE ,
	CONSTRAINT fk_InternationalLicenses_LocalLicenses FOREIGN KEY ( IssuedUsingLocalLicenseID ) REFERENCES dbo.LocalLicenses( LocalLicenseID )  
 );
GO
...
CREATE  TABLE dbo.TestAppointments ( 
	...
	CONSTRAINT fk_TestAppointments_Applications FOREIGN KEY ( RetakeFailedTestApplicationID ) REFERENCES dbo.Applications( ApplicationID )  ,
...
CREATE  TABLE dbo.Tests ( 
	...
	CONSTRAINT fk_Tests_TestsAppointments FOREIGN KEY ( TestAppointmentID ) REFERENCES dbo.TestAppointments( TestAppointmentID )  ,
